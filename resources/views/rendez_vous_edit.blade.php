    ...
    <!-- partial:index.partial.html -->
        ...
        <div class="Card Card--horizontalSegments">
            ...
            <div class="Card-segment Card-segment--padded--large">
                ...
                <form action="{{action('Controller@annulerRdv')}}" method="post">
                    {{csrf_field()}}
                    <input name="_method" type="hidden" value="post">

                    <input type="hidden" name="tel" value="{{$tel}}">
                    <button type="submit" class="btn btn-danger">Annuler rendez-vous</button>
                </form>
                ...
                <form action="{{action('Controller@storeFiche')}}" method="post" class="Form Form--largeFields">
                    ...
                    <div class="Form-field">
                        ...
                        <div class="Form-inputBlock">
                            <input type="text" class="FormElement FormElement-input" name="nom" value="{{$fiche->nom}}">
                        </div>
                    </div>
                    ...
                    <div class="Form-field">
                        ...
                        <div class="Form-inputBlock">
                            <input type="date" class="FormElement FormElement-input" name="ddn" value="{{$fiche->ddn}}">
                        </div>
                    </div>
                    ...
                    <div class="Form-field">
                        ...
                        <div class="Form-inputBlock">
                            <select name="motif_test" id="motif_test" class="form-group">
                                <option value="{{$fiche->motif_test}}"> {{$fiche->motif_test}} </option>
                                <option disabled> ---------------- </option>
                    ...
                    <div class="Form-field" id="hidden_div" style="display: none;">
                        ...
                        <div class="Form-inputBlock">
                            <input type="text" id="date_voyage" class="FormElement FormElement-input" name="date_voyage"
                                value="{{$fiche->date_voyage}}">
                        </div>
                    </div>
